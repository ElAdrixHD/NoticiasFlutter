...
NewsResponse newsResponseFromJson(String str) => NewsResponse._fromJson(json.decode(str));
...
class NewsResponse {
  ...
  factory NewsResponse._fromJson(Map<String, dynamic> json) => NewsResponse(
    status: json["status"],
